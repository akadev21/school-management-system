...
Route::prefix('users')->group(function(){ //// add below ->///
...
Route::prefix('profile')->group(function(){ //// add below ->///
...
Route::prefix('setups')->group(function(){ //// add below ->///
//Student class route
Route::get('student/class/view', [StudentClassController::class,'ViewStudent'] )->name('student.class.view');
Route::get('student/class/add', [StudentClassController::class,'StudentClassAdd'] )->name('student.class.add');
Route::post('store/class/store', [StudentClassController::class, 'StudentClassStore'])->name('store.student.class');
...
Route::post('store/year/store', [StudentYearController::class, 'StudentYearStore'])->name('store.student.year');
...
Route::post('store/group/store', [StudentGroupController::class, 'StudentGroupStore'])->name('store.student.group');
...
Route::post('store/shift/store', [StudentshiftController::class, 'StudentShiftStore'])->name('store.student.shift');
...
Route::get('reg/promortion/{student_id}', [StudentRegController::class, 'StudentRegPromotion'])->name('student.registration.promotion');
