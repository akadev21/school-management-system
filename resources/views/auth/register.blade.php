...
name="email"  class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Email">
            </div>
        </div>
        <div class="form-group">
            <div class="input-group mb-3">
 ...
 name="password_confirmation"class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Confirm Password">
            </div>
        </div>
          <div class="row">
            <div class="col-12">
    ...
    <div class="text-center">
        <p class="mt-15 mb-0 text-white">Already have an account?<a href="{{route('login')}}">Sign In</a> </a></p>
    </div>
</div>
</div>
</div>
